...
bf_residuals <- function(x, resid, pos = NULL, na.val = NULL, description = NULL,
                         registry = NULL){
  ...
  #   description <- paste0("the bits encode the residuals in column '", resid, "' [", enc$sign, ".", enc$exponent, ".", enc$mantissa, "].")
  # }
  #
  # prov <- list(wasDerivedFrom = resid,
